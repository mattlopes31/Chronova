        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-primary-400 font-medium">Gestion du temps</p>
            </div>
          </div>
          ...
          <p className="text-gray-400 text-lg max-w-md leading-relaxed">
            Saisissez vos heures par projet, gérez vos congés et suivez 
            votre temps de travail en toute simplicité.
          </p>
          
          <div className="mt-12 grid grid-cols-2 gap-6">
            {[
              { label: 'Pointage', value: 'Hebdomadaire' },
              { label: 'Validation', value: 'Manager' },
              { label: 'Congés', value: 'Intégrés' },
              { label: 'Heures sup', value: 'Calculées' },
            ].map((item, i) => (
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
            ...
            <span className="text-2xl font-bold text-gray-900">Chronova</span>
          </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
